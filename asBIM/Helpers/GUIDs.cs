...
namespace asBIM
{
    internal class GUIDs
    {
        ...
        public string PRO_TopPoint = "22c86588-f717-403e-b1c6-1607cac39965"; //PRO_Отметка верха
        public string PRO_BottomPoint = "b0ed44c1-724e-4301-b489-8d89c02acec5"; //PRO_Отметка низа
